...
// src/pages/api/events.ts
export const prerender = false; // This tells Astro to run this server-side
...
//const eventOrganizers: EventOrganizer[] = [
    import organizersData from '../../data/event-organizers.json';
    const eventOrganizers: EventOrganizer[] = organizersData;
  {
    id: "tfo-canada",
