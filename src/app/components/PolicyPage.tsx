    ...
    <div>
      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
        <article className="prose prose-lg max-w-none
          prose-h2:text-3xl prose-h2:font-bold prose-h2:text-[#002868] prose-h2:mt-8 prose-h2:mb-4 prose-h2:border-b-2 prose-h2:border-[#ff6b35] prose-h2:pb-2
          ...
          prose-a:text-[#ff6b35] prose-a:font-semibold prose-a:no-underline hover:prose-a:underline
          prose-ul:text-gray-700 prose-ul:space-y-2 prose-ul:my-4
